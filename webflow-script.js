...
'      <h3>Test 1 Registration</h3>' + 
'      <div class="field radio 691200 required" >' + 
'<label for="691200"><input id="691200" name="registration-type" class="required" type="radio" value="1000.000000" maxlength="255" data-short-name="Gold" data-ticket-quantity="8" data-registration-type-value="688132" data-non-deductible-amount="80.000000"></input><span class="label">$1,000.00 - Gold: Benefits</span></label>' + 
'</div>' + 
'<div class="field radio 691201 required" >' + 
'<label for="691201"><input id="691201" name="registration-type" class="required" type="radio" value="75.000000" maxlength="255" data-short-name="1" data-ticket-quantity="1" data-registration-type-value="688133" data-non-deductible-amount="10.000000"></input><span class="label">$75.00 - 1: Dinner</span></label>' + 
'</div>' + 
'' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha689152"></div>' + 
'' + 
'</div>' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml689152 = '<div class=\'donation-success\'>' +
                                                       ...
                                                       '  <p>Your registration for our event has been successfully processed. We look forward to seeing you there!</p>' + 
                                                        ...
                                                        '</div>';( function($) {if (Bloomerang.useDonationId('689152')) { 
                                ...
                                html689152 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                            }if (jQuery('#bloomerangForm689152').length) {
                        
                    if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                        html689152 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                        ...
                        jQuery('#bloomerangForm689152').after(html689152);
...
Bloomerang.Data.PayPal.IsPayPalPaymentMethodVaultingEnabled = false;Bloomerang.Data.PayPal.IsVenmoSameDayDonationEnabled = false;
                        ...
                        function initializeCaptcha() {
                            Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                                ...
                                function() {
                                    ...
                                    jQuery('form.registration-form').data('captcha-id', grecaptcha.render('captcha689152', { 'sitekey' : '6Ld8kg8sAAAAAP8ECpMcXxW103rW_nvbr7EoDQrz' }));
        ...
        Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
            ...
            formContainer.show();
            formContainer.html(successHtml689152);
              ...
              jQuery(e).toggle();
                ...
                var startBloomerangLoad = function() {
                    if (window.bloomerangLoadStarted == undefined) {
                        ...
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm689152(); })});
                    }
                    else {
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm689152(); })});
                    }
